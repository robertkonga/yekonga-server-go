...
## Features
  * Lightweight and [fast](https://github.com/robertkonga/yekonga-server-go/plugins/sql-benchmark "golang MySQL-Driver performance")
  * Native Go implementation. No C-bindings, just pure Go
  * Connections over TCP/IPv4, TCP/IPv6, Unix domain sockets or [custom protocols](https://godoc.org/github.com/robertkonga/yekonga-server-go/plugins/mysql#DialFunc)
...
```bash
go get -u github.com/robertkonga/yekonga-server-go/plugins/mysql
```
...
import (
	...
	_ "github.com/robertkonga/yekonga-server-go/plugins/mysql"
)
...
[Examples are available in our Wiki](https://github.com/robertkonga/yekonga-server-go/plugins/mysql/wiki/Examples "Go-MySQL-Driver Examples").
...
Alternatively, [Config.FormatDSN](https://godoc.org/github.com/robertkonga/yekonga-server-go/plugins/mysql#Config.FormatDSN) can be used to create a DSN string by filling a struct.
...
Default:        false
```
`allowOldPasswords=true` allows the usage of the insecure old password method. This should be avoided, but is necessary in some cases. See also [the old_passwords wiki page](https://github.com/robertkonga/yekonga-server-go/plugins/mysql/wiki/old_passwords).
...
Server public keys can be registered with [`mysql.RegisterServerPubKey`](https://godoc.org/github.com/robertkonga/yekonga-server-go/plugins/mysql#RegisterServerPubKey), which can then be used by the assigned name in the DSN.
...
```go
import "github.com/robertkonga/yekonga-server-go/plugins/mysql"
```
...
See the [godoc of Go-MySQL-Driver](https://godoc.org/github.com/robertkonga/yekonga-server-go/plugins/mysql "golang mysql driver documentation") for details.
...
**Caution:** As of Go 1.1, this makes `time.Time` the only variable type you can scan `DATE` and `DATETIME` values into. This breaks for example [`sql.RawBytes` support](https://github.com/robertkonga/yekonga-server-go/plugins/mysql/wiki/Examples#rawbytes).
...
## Testing / Development
To run the driver tests you may need to adjust the configuration. See the [Testing Wiki-Page](https://github.com/robertkonga/yekonga-server-go/plugins/mysql/wiki/Testing "Testing") for details.

Go-MySQL-Driver is not feature-complete yet. Your help is very appreciated.
If you want to contribute, you can work on an [open issue](https://github.com/robertkonga/yekonga-server-go/plugins/mysql/issues?state=open) or review a [pull request](https://github.com/robertkonga/yekonga-server-go/plugins/mysql/pulls).

See the [Contribution Guidelines](https://github.com/robertkonga/yekonga-server-go/plugins/mysql/blob/master/.github/CONTRIBUTING.md) for details.

---------------------------------------

## License
Go-MySQL-Driver is licensed under the [Mozilla Public License Version 2.0](https://raw.github.com/robertkonga/yekonga-server-go/plugins/mysql/master/LICENSE)
...
You can read the full terms here: [LICENSE](https://raw.github.com/robertkonga/yekonga-server-go/plugins/mysql/master/LICENSE).
