...
var (
	...
	ErrOldPassword       = errors.New("this user requires old password authentication. If you still want to use it, please add 'allowOldPasswords=1' to your DSN. See also https://github.com/robertkonga/yekonga-server-go/plugins/mysql/wiki/old_passwords")
	...
	// See https://github.com/robertkonga/yekonga-server-go/plugins/mysql/pull/302
